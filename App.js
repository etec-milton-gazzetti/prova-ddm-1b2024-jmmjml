    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.partedotexto}>
        ...
        <Text style={styles.texto}>
          ...
          desenvolvimento da trigonometria ao longo dos séculos. Por exemplo, o
          matemático indiano Aryabhata, no século V d.C., fez avanços
        ...
        <Text style={styles.texto}>
          Durante a Renascença, a trigonometria foi ainda mais desenvolvida por
          matemáticos como Johannes Kepler e François Viète. No século XVII, a
          trigonometria foi formalizada com a introdução das funções
          trigonométricas como conhecemos hoje.
        </Text>
        <Text style={styles.titulo3}>Aplicações</Text>
        <Text style={styles.texto}>
        A trigonometria é amplamente aplicada em várias áreas da ciência, engenharia e tecnologia. Algumas das suas aplicações mais comuns incluem:
        </Text>
        <Text style={styles.texto}><Text style={styles.texto2}>Engenharia:</Text> Utilizada em projetos de construção civil, engenharia elétrica, engenharia mecânica, entre outras áreas, para resolver problemas relacionados a forças, movimento, construção de estruturas, etc.</Text>
        <Text style={styles.texto}><Text style={styles.texto2}>Física:</Text> Usada na descrição de movimentos oscilatórios, ondas, acústica, óptica e na análise de sistemas de partículas.</Text>
        <Text style={styles.texto}><Text style={styles.texto2}>Astronomia:</Text> Fundamental para calcular posições de corpos celestes, prever eclipses, determinar trajetórias de satélites e muito mais.</Text>
        <Text style={styles.texto}><Text style={styles.texto2}>Navegação:</Text> A trigonometria é essencial para determinar a posição de uma embarcação usando coordenadas geográficas e observações de estrelas e planetas.</Text>
        <Text style={styles.texto}><Text style={styles.texto2}>Computação Gráfica e Jogos:</Text> Muitas técnicas de computação gráfica e design de jogos dependem fortemente de trigonometria para renderizar gráficos 3D, animações, simulações físicas, etc.</Text>
        <Text style={styles.texto}><Text style={styles.texto2}>Ciências da Computação:</Text> Usada em algoritmos de visão computacional, processamento de sinais, criptografia e muito mais.</Text>
      </ScrollView>
